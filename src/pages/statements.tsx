      ...
      <StatementContainer>
        {statements.length
          ? statements.map((statement) => (
              <StatementItem>
                <Item>NAME: {statement.authority?.name}</Item>
                <Item>
                  DATE:{" "}
                  {statement.stored
                ...
                <Item>ID: {statement.id}</Item>
                <Item>
                  Object:
                  {
                    // @ts-ignore
                    Object.values(statement.object.definition.name)
                  }
                </Item>
                <Item>Verb: {Object.values(statement.verb.display)}</Item>
              </StatementItem>
            ))
          : "Статистики нет"}
      </StatementContainer>
